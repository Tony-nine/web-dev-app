...
const DrugstoreCatalogModalUpdate = ({ isOpen, onRequestClose, updateId }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await fetch(`http://localhost:5000/api/stores/${updateId}`, {
          method: 'PUT',
          body: JSON.stringify({
            name: name,
            city: city,
  ...
  return (
    <Modal isOpen={isOpen} onRequestClose={onRequestClose} updateId={updateId}>
      <h2 className='modal_h2'>Update Drugstore</h2>
...
export default DrugstoreCatalogModalUpdate;
